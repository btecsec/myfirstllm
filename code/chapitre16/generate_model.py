...
# Ajouter le chemin pour importer depuis code.chapitre5
import os
import sys
...
try:
    from code.chapitre5.prepare_data import prepare_penguins_data
except ModuleNotFoundError:
    # Fallback for different execution contexts
    sys.path.append(os.path.abspath(os.path.join(current_dir, '..')))
    from chapitre5.prepare_data import prepare_penguins_data
...
def generate_model():
    ...
    # 1. Utiliser la fonction du chapitre 5
